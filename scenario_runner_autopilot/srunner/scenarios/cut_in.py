...
class CutIn(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        behaviour.add_child(LogBehaviour(self.config.name))
        ...
        # build tree
        root = py_trees.composites.Sequence("Behavior", policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE) # TODO why is this a sequence with a parallelpolicy
