...
from srunner.scenariomanager.scenarioatomics.atomic_behaviors import BicycleFlow, TrafficLightFreezer, ScenarioTimeout, LogBehaviour
...
class CrossingBicycleFlow(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        log_sequence = py_trees.composites.Sequence(name="CrossingBicycleFlow")
        ...
        log_sequence.add_child(LogBehaviour(self.config.name))
        log_sequence.add_child(root)
        ...
        sequence.add_child(log_sequence)
        return sequence
