...
bash {carla_root}/CarlaUE4.sh -nullrhi -nosound --world-port=$FREE_WORLD_PORT -carla-streaming-port=$FREE_STREAMING_PORT &
...
def make_jobsub_file(data_save_root, jobname, route_file_number, partition_name, repetition, timeout="0-02:00"):
...
sleep $((2 + $RANDOM % 15)) # TODO this is specific to our cluster, which can have issues with the ports when jobs are deployed on the same node at once
...
if __name__ == "__main__":
    ...
    repetition_start = 0
    partition = "day"
    job_name = "2cpucollect"
    username = "gerstenecker"
    code_root = "/home/gerstenecker/PlanT_2_cleanup"
    carla_root = "/home/gerstenecker/garage_2_cleanup/carla"
    date = datetime.today().strftime("%Y_%m_%d")
    dataset_name = "PlanT_2_" + date
    ...
    # debug_routes = [
    # # "/home/gerstenecker/datagen/carla_garage/data/50x36_Town13/ParkingCutIn/1037_1.xml",
    # # "/home/gerstenecker/datagen/carla_garage/data/50x36_Town13/ConstructionObstacleTwoWays/1591_0.xml",
    # "/home/gerstenecker/datagen/carla_garage/data/50x38_Town12/YieldToEmergencyVehicle/928_0.xml",
    # "/home/gerstenecker/datagen/carla_garage/data/50x36_Town13/OppositeVehicleRunningRedLight/7_0.xml",
    # "/home/gerstenecker/datagen/carla_garage/data/50x36_Town13/VehicleOpensDoorTwoWays/19_0.xml"
    # # "/home/gerstenecker/datagen/carla_garage/data/50x36_Town13/InvadingTurn/1485_0.xml",
    # ]
    # routes = debug_routes # sorted(routes, key=lambda l: l not in debug_routes)
    ...
    for repetition in range(repetition_start, repetitions):
        for route in routes:
            ...
            agent = f"{code_root}/carla_garage/data_agent.py"
            ...
            job_file = make_jobsub_file(data_save_directory, job_name, routefile_number, partition, repetition, "0-02:00")
